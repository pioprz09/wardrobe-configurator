...
export const WARDROBE_CONSTANTS = {
  ...
  // Limity modułów
  MIN_MODULE_WIDTH: 300,   // ← było 350
  MAX_MODULE_WIDTH: 1100,
  DOUBLE_DOOR_THRESHOLD: 600, // ← było 550 | poniżej 600mm = 1 skrzydło, od 600mm = 2 skrzydła
  ...
  BASE_PRICES: {
    AREA_MULTIPLIER: 280,
    DEPTH_MULTIPLIER: 120,
    HANDLE_PRICE: 35,
    COLOR_PREMIUM_MULTIPLIER: 1.15
  },
...
export const validateModuleConfiguration = (moduleWidths) => {
  ...
  return moduleWidths.every(width => width >= MIN_MODULE_WIDTH && width <= MAX_MODULE_WIDTH);
};
...
export const calculatePrice = (width, height, depth, modules, exteriorColor, handleType, numModules) => {
  ...
  const modulePrice = modules.reduce((sum) => sum + 0, 0);
